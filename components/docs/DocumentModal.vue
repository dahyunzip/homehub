    ...
    <div class="modal-backdrop" @click.self="$emit('close')">
      <div class="modal">
        ...
        <div class="modal-body">
          ...
          <div class="field">
            <label>내용</label>
            <textarea v-model="form.content" placeholder="문서 내용을 입력하세요" rows="10" />
          </div>

          <!-- 첨부파일 (UI only — Supabase Storage 버킷 설정 후 활성화) -->
          <div class="field attach-field">
            <label>
              첨부파일
              <span class="attach-notice">Supabase Storage 버킷 설정 후 이용 가능</span>
            </label>
            <div class="attach-zone" @dragover.prevent @drop.prevent="onDrop">
